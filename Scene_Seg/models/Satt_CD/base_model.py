...
class BaseModel():
    ...
    def update_learning_rate_cos(self,init_lr,cur_epoch,cycle_epcohs):
        ...
        #     self.schedulers.step()
        # else:
        from models.Satt_CD.modules.utils import get_cos_lr,get_step_lr,get_poly_lr
        #lr = get_cos_lr(init_lr, cur_epoch, cycle_epcohs)
        #lr = get_step_lr(init_lr, cur_epoch, cycle_epcohs)
        lr = get_poly_lr(init_lr, cur_epoch, cycle_epcohs)
