...
# Default config as proposed by Philipp Kraehenbuehl and Vladlen Koltun,  for BRSeg, use blur=1 get much better performance than blur=4
default_conf = {
    'filter_size': 11,
    'blur': 2,
    'merge': True,
...
class GaussCRF(nn.Module):
    ...
    def forward(self, unary, img, num_iter=5):
        ...
        pos_feats = self.create_position_feats(sdims=self.pos_sdims, bs=bs)#pos_sdims=0.3333 [1,2,366,500]
